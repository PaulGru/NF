# https://github.com/DakshIdnani/pytorch-nice
...
cfg = {
  ...
  'NUM_NET_LAYERS': 8,  # neural net layers for each coupling layer
...
class LogisticDistribution(Distribution):
    ...
    def sample(self, size):
        # Crée un échantillon d'une distribution uniforme entre 0 et 1 avec la taille spécifiée size.
...
# Visualize the transformation from logistic distribution to two moons
num_samples = 1000
with torch.no_grad():
...
plt.title('Transformed Points from Logistic Distribution to Two Moons')
plt.xlabel('x1')
plt.ylabel('x2')
plt.legend()
plt.grid(True)
